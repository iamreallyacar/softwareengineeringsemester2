...
import { UserRoundCog, Home } from "lucide-react";
                ...
                <div className="profile-content-wrapper">
                    <div className="profile-login-content">
                        <div className="profile-title-container">
                            <UserRoundCog className="title-icon" />
                            <h1 className="profile-login-title">My Profile</h1>
                        </div>
                                            ...
                                            <li key={home.id} className="home-item">
                                                ...
                                                <div className="password-update-form">
                                                    ...
                                                    {passwordErrors[home.id] && (
                                                        <p className={passwordErrors[home.id].includes("successfully") ? "profile-success-message" : "profile-error-message"}>
                                                            {passwordErrors[home.id]}
                                                        </p>
                                                    )}
                                                </div>
