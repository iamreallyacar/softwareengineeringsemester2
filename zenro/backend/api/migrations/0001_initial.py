# Generated by Django 5.1.4 on 2025-02-17 02:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unlock_order', models.PositiveIntegerField(null=True)),
            ],
        ),
        migrations.CreateModel(
            name='DeviceLog5Sec',
        ...
        migrations.AddField(
            model_name='device',
            name='room',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='devices', to='api.room'),
        ),
        migrations.CreateModel(
            name='RoomLog5Sec',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_type', models.CharField(default=None, max_length=10, null=True)),
                ('memory_type', models.CharField(choices=[('input', 'Input'), ('output', 'Output'), ('memory', 'Memory')], max_length=10)),
                ('home_io_room', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.homeioroom')),
            ],
        ),
        migrations.AddField(
            model_name='device',
        ...
        migrations.AddConstraint(
            model_name='room',
            constraint=models.UniqueConstraint(fields=('name', 'smart_home'), name='unique_room_in_home'),
        ),
        migrations.AddConstraint(
            model_name='supporteddevice',
            constraint=models.UniqueConstraint(fields=('address', 'data_type', 'memory_type'), name='unique_addr_data_memtype'),
        ),
        migrations.AddConstraint(
            model_name='device',
